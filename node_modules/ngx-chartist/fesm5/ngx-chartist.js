...
var NgxChartistService = /** @class */ (function () {
    ...
    function (target) {
        ...
        return extend.apply(Chartist, __spread([target], sources));
    };
    /**
     * @param {?} str
     * @param {?} subStr
...
var NgxChartistComponent = /** @class */ (function () {
    ...
    NgxChartistComponent.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
