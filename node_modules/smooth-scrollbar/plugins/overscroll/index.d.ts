...
export default class OverscrollPlugin extends ScrollbarPlugin {
    ...
    private _willOverscroll(direction, delta);
    private _absorbMomentum(direction, remainMomentum);
    private _addAmplitude(direction, delta);
    private _render();
    private _nextAmp(direction);
}
