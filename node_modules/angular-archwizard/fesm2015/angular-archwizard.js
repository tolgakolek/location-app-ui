import { Directive, TemplateRef, ContentChild, EventEmitter, HostBinding, Input, Output, Component, forwardRef, ViewEncapsulation, Injectable, ContentChildren, Host, HostListener, Optional, NgModule } from '@angular/core';
