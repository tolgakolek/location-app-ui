(function (global, factory) {
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, pathsChanges$.pipe(operators.startWith({ newArr: paths.getArray() }), // in order to subscribe to them all
                                operators.switchMap(function (parentMVEvent) { return rxjs.merge.apply(void 0, // rest parameter
    ...
    var TransitLayerManager = /** @class */ (function () {
        ...
        TransitLayerManager = __decorate$10([
            core.Injectable(),
            __metadata$9("design:paramtypes", [GoogleMapsAPIWrapper])
        ], TransitLayerManager);
    ...
    var FitBoundsService = /** @class */ (function () {
        ...
        FitBoundsService = __decorate$11([
            core.Injectable(),
            __metadata$10("design:paramtypes", [MapsAPILoader])
        ], FitBoundsService);
    ...
    var AgmMap = /** @class */ (function () {
        ...
        AgmMap = AgmMap_1 = __decorate$12([
            ...
            __metadata$11("design:paramtypes", [core.ElementRef, GoogleMapsAPIWrapper, FitBoundsService, core.NgZone])
        ], AgmMap);
        return AgmMap;
    }());
    ...
    var AgmCircle = /** @class */ (function () {
        ...
        AgmCircle = AgmCircle_1 = __decorate$13([
            core.Directive({
                selector: 'agm-circle'
            }),
            __metadata$12("design:paramtypes", [CircleManager])
        ], AgmCircle);
        return AgmCircle;
    }());
    ...
    var AgmRectangle = /** @class */ (function () {
        ...
        AgmRectangle = AgmRectangle_1 = __decorate$14([
            core.Directive({
                selector: 'agm-rectangle'
            }),
            __metadata$13("design:paramtypes", [RectangleManager])
        ], AgmRectangle);
        return AgmRectangle;
    }());
    ...
    var AgmInfoWindow = /** @class */ (function () {
        ...
        AgmInfoWindow = AgmInfoWindow_1 = __decorate$15([
            core.Component({
                selector: 'agm-info-window',
                template: "<div class='agm-info-window-content'>\n      <ng-content></ng-content>\n    </div>\n  "
            }),
            __metadata$14("design:paramtypes", [InfoWindowManager, core.ElementRef])
        ], AgmInfoWindow);
    ...
    var AgmKmlLayer = /** @class */ (function () {
        ...
        AgmKmlLayer = AgmKmlLayer_1 = __decorate$16([
            core.Directive({
                selector: 'agm-kml-layer'
            }),
            __metadata$15("design:paramtypes", [KmlLayerManager])
        ], AgmKmlLayer);
        return AgmKmlLayer;
    }());
    ...
    var AgmDataLayer = /** @class */ (function () {
        ...
        AgmDataLayer = AgmDataLayer_1 = __decorate$17([
            core.Directive({
                selector: 'agm-data-layer'
            }),
            __metadata$16("design:paramtypes", [DataLayerManager])
        ], AgmDataLayer);
        return AgmDataLayer;
    }());
    ...
    var AgmTransitLayer = /** @class */ (function () {
        ...
        AgmTransitLayer = AgmTransitLayer_1 = __decorate$18([
            core.Directive({
                selector: 'agm-transit-layer'
            }),
            __metadata$17("design:paramtypes", [TransitLayerManager])
        ], AgmTransitLayer);
    ...
    var AgmPolylinePoint = /** @class */ (function () {
        ...
        AgmPolylinePoint = __decorate$21([
    ...
    var AgmFitBounds = /** @class */ (function () {
        ...
        AgmFitBounds = __decorate$24([
            core.Directive({
                selector: '[agmFitBounds]'
            }),
            __param(0, core.Self()),
            __metadata$23("design:paramtypes", [FitBoundsAccessor,
                FitBoundsService])
        ], AgmFitBounds);
        return AgmFitBounds;
    }());
    ...
    var LazyMapsAPILoader = /** @class */ (function (_super) {
        ...
        LazyMapsAPILoader = __decorate$25([
            core.Injectable(),
            __param$1(0, core.Optional()), __param$1(0, core.Inject(LAZY_MAPS_API_CONFIG)),
            __metadata$24("design:paramtypes", [Object, WindowRef, DocumentRef])
        ], LazyMapsAPILoader);
    ...
    var AgmCoreModule = /** @class */ (function () {
        ...
        var AgmCoreModule_1;
        AgmCoreModule = AgmCoreModule_1 = __decorate$26([
    ...
    exports.TransitLayerManager = TransitLayerManager;
