...
import { SortDirection } from '../../helpers/table-sortable/user-contact-type-advanced-sortable.directive';
...
export class TableService {
    ...
    constructor(private pipe: DecimalPipe,private tableListService:TableListService) {
        ...
        this._search$.next();
        this.tableListService.getAll(USERCONTACTTYPE_PATH).subscribe(data => {
            this.content = data;
          });
    }
    /**
